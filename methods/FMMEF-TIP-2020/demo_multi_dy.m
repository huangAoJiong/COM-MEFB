...
imgSeqColor= loadImg('D:\Papers\3\model4'); % [0,1]
...
figure,imshow(C_out)
%     imwrite(C_out,'D:\Papers\3\model_res\4_FMMEF-TIP-2020.tif');
% imwrite(C_out(:,:,1),'D:\Papers\3\2_Res\FMMEF_TIP_Structural Patch_2020.bmp')